...
::: {.callout-note}
En este punto de la instalación se activará el **Control de cuentas de usuario** de Windows. Hacer clic en **Sí**
:::
...
-   Ir hasta esta sección de la página. Hacer clic en **DOWNLOAD RSTUDIO DESKTOP FOR WINDOWS**. Esto iniciara la descarga `RStudio-2024.09.0-375.exe`
...
-   Ir a <https://quarto.org>

-   Hacer clic en **Get Started**

-   Hacer clic en **Download Quarto CLI**
