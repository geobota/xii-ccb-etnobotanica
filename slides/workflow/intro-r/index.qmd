...
``` {.r filename="script.r" code-line-numbers="true" style="font-size: 100%"}
# Instalar paquetes
install.packages(
  c(
    "tidyverse",
...
::: columns
::: {.column width="60%"}
Sistema para la creación de gráficos. Se basa en la gramática de gráficos[^1], permitiendo construir gráficos de manera declarativa mediante capas de componentes, como datos, escalas, geoms (formas geométricas), facetas y temas.
:::

::: {.column width="40%"}
![](images/ggplot2.png){fig-align="center" width="300"}
...
[^1]: Marco teórico para construir gráficos de manera sistemática y coherente. Fue desarrollada por Leland Wilkinson.
